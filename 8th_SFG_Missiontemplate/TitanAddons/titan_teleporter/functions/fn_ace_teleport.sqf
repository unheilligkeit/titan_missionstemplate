...
[_controller, 0, ["ACE_MainActions"], _titan_tp_main] call ace_interact_menu_fnc_addActionToObject;
    ...
    _titan_tp_titan_3 = ["titan_tp_titan_3", "Titan 2", "", { [player, "TITAn_3_0"] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
    [_controller, 0, ["ACE_MainActions", "titan_tp_main"], _titan_tp_titan_3] call ace_interact_menu_fnc_addActionToObject;

        _titan_tp_titan_3_0 = ["titan_tp_titan_3_0", "Titan 2_0", "", { [player, "TITAn_3_0" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_3_1 = ["titan_tp_titan_3_1", "Titan 2_1", "", { [player, "TITAn_3_1" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_3_2 = ["titan_tp_titan_3_2", "Titan 2_2", "", { [player, "TITAn_3_2" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_3_3 = ["titan_tp_titan_3_3", "Titan 2_3", "", { [player, "TITAn_3_3" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
    ...
    _titan_tp_titan_4 = ["titan_tp_titan_4", "Titan 2", "", { [player, "TITAn_4_0"] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
    [_controller, 0, ["ACE_MainActions", "titan_tp_main"], _titan_tp_titan_4] call ace_interact_menu_fnc_addActionToObject;

        _titan_tp_titan_4_0 = ["titan_tp_titan_4_0", "Titan 2_0", "", { [player, "TITAn_4_0" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_4_1 = ["titan_tp_titan_4_1", "Titan 2_1", "", { [player, "TITAn_4_1" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_4_2 = ["titan_tp_titan_4_2", "Titan 2_2", "", { [player, "TITAn_4_2" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
        ...
        _titan_tp_titan_4_3 = ["titan_tp_titan_4_3", "Titan 2_3", "", { [player, "TITAn_4_3" ] call titanTP_fnc_teleport_to_group }, {true}] call ace_interact_menu_fnc_createAction;
