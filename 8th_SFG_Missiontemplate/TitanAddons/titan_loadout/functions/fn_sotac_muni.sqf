/*
Hinzufügen von Mmunition für sotac

[player] call titan_fnc_sotac_muni;
...
for "_i" from 1 to 4 do {_unit addItem "ACE_HuntIR_M203";};
for "_i" from 1 to 2 do {_unit addItem "ACE_HandFlare_Yellow";};
for "_i" from 1 to 2 do {_unit addItem "ACE_HandFlare_Green";};
for "_i" from 1 to 4 do {_unit addItem "UGL_FlareYellow_F";};
for "_i" from 1 to 4 do {_unit addItem "UGL_FlareGreen_F";};
...
for "_i" from 1 to 3 do {_unit addItem "SmokeShellYellow";};
