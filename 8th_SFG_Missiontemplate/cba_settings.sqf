...
force force ace_common_checkPBOsWhitelist = "['blast_refract','Ca','fxp_adat','fxp_VehExpEffect','fxp_VehExpEffectBig','fxp_VehHeli','fxp_VehPlane','fxp_VehTank','WarFXPE','WarFXWeps','3denEnhanced','lambs_danger','lambs_eventhandlers','lambs_main','lambs_formations','lambs_rpg','lambs_suppression','lambs_turrets','lambs_wp','vcomai','VCOM_AI','ES_main','ES_sounds','ES_sys','DS_a_Blackhawk','DS_a_Chinook','DS_a_Comanche','DS_a_Kajman','DS_a_Kasatka','DS_a_Littlebird','DS_a_Lynx','DS_a_Merlin','DS_a_Taru','DS_a_Xiang','DS_lv_HatchbackSport','DS_m_Bullets','DS_m_Explosions','DS_main','DS_sys','DS_w_4Five','DS_w_20mmGatling','DS_w_30mmgatling','DS_w_120mm','DS_w_155mm','DS_w_AA','DS_w_ACPC2','DS_w_AK12','DS_w_AKM','DS_w_AKS','DS_w_Alamut','DS_w_ASRAAM','DS_w_Autocannon','DS_w_CAR95','DS_w_CMR76','DS_w_CoaxMG','DS_w_Cyrus','DS_w_DAGR','DS_w_EBR','DS_w_EMR','DS_w_F2000','DS_w_Gau8','DS_w_GMG','DS_w_HMG','DS_w_Katiba','DS_w_Kir','DS_w_Launcher_big','DS_w_Launcher_small','DS_w_lim','DS_w_LRR','DS_w_Lynx','DS_w_M14','DS_w_MAR10','DS_w_minigun65','DS_w_minigun762','DS_w_MK200','DS_w_MLRS','DS_w_MX','DS_w_Navid','DS_w_P07','DS_w_PCML','DS_w_PDW2000','DS_w_PlaneLaunchers','DS_w_Protector','DS_w_Rahim','DS_w_Rook','DS_w_RPG7','DS_w_Scalpel','DS_w_SDAR','DS_w_Shared','DS_w_SkyFire','DS_w_SPAR','DS_w_SPAR762','DS_w_SPMG','DS_w_Sting','DS_w_Tails','DS_w_Tavor','DS_w_Titan','DS_w_Type115_1','DS_w_Type115_2','DS_w_UGL','DS_w_Vermin','DS_w_Zafir','DS_w_Zubr']";
...
force force diwako_dui_indicators_range = 30.1042;
...
force force FARE_DELAY_DEFAULT = 2;
force force FARE_DELAY_NEAR = 0;
force force FARE_DELAY_SHOOT = 3;
...
// Metis Marker
force force mts_markers_saveLastSelection = true;
force force mts_markers_showPresetsUI = false;
