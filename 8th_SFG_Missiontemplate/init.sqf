...
// Titan arsenal
box_arsenal_normal addAction ["<t color='#FCB514'> Air-Support </t>","createDialog 'titan_arsenal_gui'","", 100, false, True, "", "", 5];
box_arsenal_pilot addAction ["<t color='#FCB514'> Air-Support </t>","createDialog 'titan_arsenal_pilot_gui'","", 100, false, True, "", "", 5];
// Storyline
