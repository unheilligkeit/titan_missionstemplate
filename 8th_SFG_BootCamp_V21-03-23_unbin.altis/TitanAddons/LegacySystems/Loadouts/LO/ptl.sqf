		...
		switch (_plastr) do {
			...
			case "C1": { 
				...
				if (_selectuni == "mtp") then {
					player addBackpack "SOG_PTL_MTP";
				...
				if (_selectuni == "wtp") then {
					player addBackpack "SOG_PTL_WTP";
			...
			case "o13": {	// Capon
				...
				if (_selectuni == "mtp") then {
					player addBackpack "SOG_PTL_MTP";
					player addWeapon "SMA_M4afg";
					player addPrimaryWeaponItem "SMA_SFPEQ_M4TOP_tan";
					player addPrimaryWeaponItem "SMA_CMORE";
					player addItemToUniform "SMA_ELCAN_SPECTER_TAN_ARDRDS";
					player addItemToBackpack "dcd_suck_m203";
				};
			...
			case "o16": { //Sasch
				...
				if (_selectuni == "mtp") then {
					player addBackpack "SOG_SQL_MTP";
				...
				if (_selectuni == "wtp") then {
					player addBackpack "SOG_SQL_WTP";
